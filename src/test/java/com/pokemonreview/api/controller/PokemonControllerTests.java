...
public class PokemonControllerTests {
    ...
    @Test
    public void PokemonController_CreatePokemon_ReturnPokemonDto() throws Exception {
    ...
    @Test
    public void PokemonControllerTests_GetAllPokemon_ReturnResponseDto() throws Exception {
    ...
    @Test
    public void PokemonController_PokemonDto_ReturnPokemonDto() throws Exception {
        int pokemonId = 1;
    ...
    @Test
    public void PokemonControllerTest_DeletePokemon_returnString() throws Exception {
        int pokemonId = 1;
        ResultActions response = mockMvc.perform(delete("/api/pokemon/1/delete").contentType(MediaType.APPLICATION_JSON));
        response.andExpect(MockMvcResultMatchers.status().isOk());
    }
